...
```
cd existing_repo
git remote add origin https://forge.univ-lyon1.fr/sa-s101/sae_s1.01-s1.02.git
git branch -M main
...
- [ ] [Set up project integrations](https://forge.univ-lyon1.fr/sa-s101/sae_s1.01-s1.02/-/settings/integrations)
